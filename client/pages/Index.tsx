            ...
            <div className="relative group border rounded-3xl p-8 hover:border-primary/50 transition-all hover:shadow-xl bg-white flex flex-col">
              ...
              <ul className="space-y-3 mb-8 text-xs">
                <li className="flex items-center gap-2">
                  ...
                  <span>Connexion par Email & MDP</span>
                </li>
                <li className="flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-green-500" />
                ...
                <li className="flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-green-500" />
                  <span>3 Notifications incluses</span>
                </li>
              </ul>
...
function FeatureCard({ icon, title, description, link }: { icon: React.ReactNode, title: string, description: string, link: string }) {
  return (
    <Link to={link} className="block group">
      <div className="p-8 border rounded-3xl bg-white hover:shadow-xl transition-all h-full flex flex-col">
